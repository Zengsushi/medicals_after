...
class UserService:
    ...
    def get_user_list(self, page, page_size, search, status=None, role=None) -> Any:
        """
        用户列表获取
        :param page:
        :param page_size
        ...
        if role == "super":
            ...
            conditions.append(and_(User.is_superuser == False, User.is_staff == True))
        elif role == "normal":
            conditions.append(and_(User.is_superuser == False, User.is_staff == False))
