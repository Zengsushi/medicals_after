...
from users.security_models import DeviceSession, AuditLog, RefreshToken, PasswordResetToken, AUDIT_ACTIONS
...
class AuthService:
    ...
    def _build_menus_response(user: User) -> List[Dict[str, Any]]:
        ...
        def menu_to_dict(menu) -> Dict[str, Any]:
            return {
                "id": menu.id,
                "name": menu.name,
                "path": menu.path,
